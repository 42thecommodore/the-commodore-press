...
| 2026-09-01 | The meta description now takes its counts from the build (`{{N_BOOKS}}` etc. in `templates/shell.html`). | The hand-written 'twenty ideas' would have been wrong the moment a twenty-first shipped. |
